...
config.primary.recipients[0].address = 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW';
...
function mockSetupSettings(pool, callback) {
  nock('http://127.0.0.1:9998')
    .post('/').reply(200, JSON.stringify([
      { id: 'nocktest', error: null, result: { isvalid: true, address: 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW' }},
...
function mockClient() {
  ...
  client.id = 'test';
  client.addrPrimary = 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW';
...
describe('Test pool functionality', () => {
  ...
  test('Test pool settings setup [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.setupSettings(() => {
        expect(configCopy.primary.address).toBe('B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW');
  ...
  test('Test pool settings setup [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9998')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: true, result: { isvalid: true, address: 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool settings setup [4]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9998')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: null, result: { isvalid: false, address: 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          pool.network.on('network.stopped', () => done());
          expect(response[1][0]).toBe('log');
          expect(response[1][1]).toBe('Difficulty update queued for worker: B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW (8)');
          pool.network.stopNetwork();
        }
      }
    });
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          ...
          expect(response[0][1]).toBe('Network difficulty (0) is lower than the difficulty on port 3002 (32)');
          expect(response[1][0]).toBe('log');
          expect(response[1][1]).toBe('Difficulty updated successfully for worker: B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW (8)');
          pool.network.stopNetwork();
        }
      }
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9998')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: true, address: 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW' }
        }));
      pool.checkWorker(pool.primary.daemon, 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW', (valid) => {
  ...
  test('Test pool stratum authentication [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkWorker(pool.primary.daemon, 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW.worker1', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9998')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: false, address: 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW' }
        }));
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW', () => {}, (result) => {
  ...
  test('Test pool stratum authentication [6]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [7]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW', () => {}, (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': false, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool stratum authentication [10]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW', null, 'test', (result) => {
  ...
  test('Test pool stratum authentication [11]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW', 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW', 'test', (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': true, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const blocks1 = {
      ...
      miner: 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW',
      worker: 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW.worker1',
      category: 'immature',
      confirmations: 3,
    ...
    const worker1 = {
      ...
      miner: 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW',
      worker: 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW.worker4',
      identifier: 'master',
      invalid: 0,
      round: '15c8343c-9751-4c67-aafa-29ff296da484',
      solo: false,
    ...
    const expected = { 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW': { 'immature': 10000, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW': { 'generate': 0, 'immature': 20000 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    const expected = {
      'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW': { 'immature': 5000, 'generate': 0 },
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW': { 'immature': 8474.10994411, 'generate': 0 },
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW': { 'generate': 10000, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW': { 'immature': 0, 'generate': 20000 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [9]', () => {
    ...
    const expected = { 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW': { 'immature': 0, 'generate': -10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [12]', () => {
    ...
    const expected = {
      'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW': { 'immature': 9570.0056964, 'generate': 0 },
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'B8c7sDfi1XLe5oycvaSq3hhyMekt2bJikW': { 'immature': -10000, 'generate': 10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
